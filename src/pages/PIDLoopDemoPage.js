          ...
          <Paper className={classes.paper}>
              <Grid container spacing={3} direction="row">
                  ...
                  <Grid item xs={12} >
                    ...
                    <p className={classes.para}>
                      This project came about to teach students on my <a href = "/#/FirstMentor" className={classes.link}>
                      ...
                      factors that we also had to worry about. This made it difficult to focus on what was important
                      for a PID loop.
                    </p>

                    <p className={classes.para}>
                      After thinking about the problem, I decided to build a simplified PID loop to 
                      teach the theory of a control loop without all the extraneous features to worry
                      about on a complete robot. This would allow the students to learn how to tune a 
                    ...
                    <p className={classes.para}>
                      With teaching being the primary purpose of this project, documentation is critical.
                    ...
                    <p className={classes.para}>
                      ...
                      to use a spare stepper motor I had lying around. However, after experimenting with the
                      electrical components, I realized a stepper motor is not what I wanted.
                      I needed just a basic DC motor that would let me easily vary the speed. A stepper motor
                      moves in steps, making them very accurate out of the box. However, I am adding a feedback 
                    ...
                    <p className={classes.para}>
                      ...
                      off a PWM signal from the Arduino. This change also allowed me to run the entire system off
                      a single USB cord rather than an external power adapter, as was required with the larger
                      stepper motor. 
                    </p>
                    ...
                    <p className={classes.para}>
                      Another benefit of running everything on an Arduino Uno is that the user can
                      see and modify the code that runs the whole system. If they want to learn more about
                      a PID loop or add additional features, that is entirely possible.
